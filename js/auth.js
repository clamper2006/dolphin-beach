/* ================================================================
   auth.js — Playa Delfín v2.0.1
   Authentication & Role Management
   ================================================================ */

const Auth = (() => {
  const STORAGE_KEY = 'pd_auth_users';
  ...
  const DEFAULT_USERS = [
    ...
    { id: 3, username: 'op_playa',    password: 'playa123',  nombre: 'Juan Op. Playa',       rol: 'OPERADOR_PLAYA', activo: true },
    { id: 4, username: 'op_isla',     password: 'isla123',   nombre: 'María Op. Isla',       rol: 'OPERADOR_ISLA',  activo: true }
  ];

  // Pages allowed per role
  // NOTE: OPERADOR_PLAYA can ONLY access churuatas-playa (beach huts) and about
  const PERMISOS = {
  ...
  function canAccess(page) {
    ...
    return (PERMISOS[session.rol] || []).includes(page);
  }
  ...
  function getPermisos()       { return PERMISOS; }
  function getAvailableRoles() { return Object.keys(PERMISOS); }
  ...
  return {
    ...
    getUsers, getAvailableRoles, getPermisos,
